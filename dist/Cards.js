...
var SwipeCards = function (_Component) {
	...
	function SwipeCards(props) {
		...
		_this.assignRef = _this.assignRef.bind(_this);
		return _this;
	}
	...
	_createClass(SwipeCards, [{
		...
		value: function setSize() {
			var container = _reactDom2.default.findDOMNode(this.component);
			var containerSize = {
		...
		value: function render() {
			...
			var _cards = _react2.default.Children.toArray(children).reduce(function (memo, c, i) {
			...
			return _react2.default.createElement(
				'div',
				{ ref: this.assignRef, className: className },
